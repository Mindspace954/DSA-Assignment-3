...
{
    int n, m;
    printf("Enter the initial number of elements in Array: \n");
    scanf("%d", &n);
    ...
    4. Delete Item From Last\n \
    5. Delete Item from First\n \
    6. Delete Item From Index\n \
    ...
    13. Clone Array\n \
    14. Shift Left Array\n \
    15. Shift Right Array\n \
    16. Rotate Array Clockwise\n \
    17. Rotate Array Anticlockwise\n \
    18. Find Min\n \
    20. Fill Array Pseudo Random\n \
    21. Fill Array True Random\n \
    22. Increase Array Size\n \
    23. Set Array To Zero\n \
    24. Delete All Item Of Array\n \
    25. Delete Array\n \
    26. Allocate Array\n \
    27. Print Array\n");
    int choice;
